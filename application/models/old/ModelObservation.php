            ...
            $query =
                    "
                        ...
                        FROM(
                            ...
                            AND   A.SAMPEL_ID IN (SELECT SAMPEL_ID FROM SR01_SATUSEHAT_TRANSAKSI   WHERE LOKASI_ID='001' AND AKTIF='1' AND RESOURCE_TYPE='Specimen' AND JENIS='1' AND ENVIRONMENT='development' AND SAMPEL_ID=A.SAMPEL_ID)
                            AND   A.SAMPEL_ID NOT IN (SELECT SAMPEL_ID FROM SR01_SATUSEHAT_TRANSAKSI   WHERE LOKASI_ID='001' AND AKTIF='1' AND RESOURCE_TYPE='Observation' AND JENIS='2' AND ENVIRONMENT='development' AND SAMPEL_ID=A.SAMPEL_ID AND LAYAN_ID=A.TES_ID)
                            ORDER BY CREATED_DATE ASC
