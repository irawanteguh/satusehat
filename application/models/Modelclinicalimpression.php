            ...
            $query =
                    "
                        ...
                        FROM(
                            ...
                            AND   EXISTS (SELECT 1 FROM SR01_SATUSEHAT_TRANSAKSI WHERE LOKASI_ID='001' AND AKTIF='1' AND RESOURCE_TYPE='Condition' AND ENVIRONMENT='".$env."' AND PASIEN_ID=A.PASIEN_ID AND EPISODE_ID=A.EPISODE_ID)
                        ...
                        WHERE X.CREATEDDATE IS NOT NULL
