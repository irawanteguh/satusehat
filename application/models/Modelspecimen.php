            ...
            $query =
                    "
                        SELECT A.PASIEN_ID, EPISODE_ID, TEST_ID, TRANS_CO, 
                                ...
                                (SELECT RESOURCE_ID FROM SR01_SATUSEHAT_TRANSAKSI WHERE LOKASI_ID='001' AND AKTIF='1' AND RESOURCE_TYPE='ServiceRequest' AND ENVIRONMENT='".$env."' AND PASIEN_ID=A.PASIEN_ID AND EPISODE_ID=A.EPISODE_ID)SERVICERQUEST_ID,
