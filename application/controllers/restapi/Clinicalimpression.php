<?php
    ...
    class Clinicalimpression extends MY_Satusehat_Controller{
        public static $oauth;

        public function __construct(){
            parent::__construct();
            $this->load->model("Modelclinicalimpression", "md");
        }
        
        public function cipoliklinik_post(){
            if(!isset(self::$oauth['issue'])){
                ...
                if(!empty($result)){
                    foreach ($result as $a){
                        ...
                        $clinicalimpressionresourceidentifier = [];
                        ...
                        $clinicalimpressionresourceidentifier['system'] = "http://sys-ids.kemkes.go.id/clinicalimpression/".RS_ID;
                        $clinicalimpressionresourceidentifier['use']    = "official";
                        $clinicalimpressionresourceidentifier['value']  = $identifier;
                        ...
                        foreach ($conditions as $conditionId) {
                            ...
                            $clinicalimpressionresourceproblem[] = $refcondition;
                        }

                        $clinicalimpressionresource['assessor']['reference']  = "Practitioner/".$practitionerid;
                        $clinicalimpressionresource['date']                   = $a->CREATEDDATE;
                        $clinicalimpressionresource['description']            = $a->ASSESSMENT;
                        $clinicalimpressionresource['effectiveDateTime']      = $a->CREATEDDATE;
                        $clinicalimpressionresource['encounter']['reference'] = "Encounter/".$a->RESOURCE_ID;
                        $clinicalimpressionresource['identifier'][]           = $clinicalimpressionresourceidentifier;
                        $clinicalimpressionresource['summary']                = $a->ASSESSMENT;
                        $clinicalimpressionresource['problem']                = $clinicalimpressionresourceproblem;
                        $clinicalimpressionresource['resourceType']           = "ClinicalImpression";
                        $clinicalimpressionresource['status']                 = "completed";
                        $clinicalimpressionresource['subject']['reference']   = "Patient/".$patientid;
                        $clinicalimpressionresource['subject']['display']     = $patientname;

                        $clinicalimpression['fullUrl']           = "urn:uuid:".Satusehat::uuid();
                        $clinicalimpression['request']['method'] = "POST";
                        $clinicalimpression['request']['url']    = "ClinicalImpression";
                        $clinicalimpression['resource']          = $clinicalimpressionresource;

                        $body['resourceType'] = "Bundle";
                        $body['type']         = "transaction";
                        $body['entry'][]      = $clinicalimpression;
                   ...
                   $response = Satusehat::postbundle(json_encode($body),self::$oauth['access_token']);
                        ...
                        if(isset($response['entry'])){
                            ...
                            if($response === null){
                                $statusColor = "red";
                                echo formatlogbundle($pasienid,$episodeid,'ClinicalImpression','','ERROR | response | NULL response from SATUSEHAT',$statusColor);
                            }else{
                                if(isset($response['fault'])){
                                    ...
                                    echo formatlogbundle($pasienid,$episodeid,'ClinicalImpression','',$statusMsg,$statusColor);
                                }else{
                                        ...
                                        if($response['issue'][0]['code']==="duplicate"){
                                            ...
                                            if(isset($responsegetServiceRequest['entry'])){
                                                foreach($responsegetServiceRequest['entry'] as $responsegetServiceRequests){
                                                    ...
                                                    $statusColor = "yellow";
                                                    $statusMsg   = "GET ClinicalImpression BY ACSN";
